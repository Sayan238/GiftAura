...
const TRENDING_PRODUCTS = [
  { id: 1, name: 'Premium Red Roses Bouquet', price: 999, originalPrice: 1299, rating: 4.8, reviews: 124, tag: 'Bestseller', image: '/images/products/red-roses.png' },
  { id: 2, name: 'Chocolate Truffle Cake (1kg)', price: 850, originalPrice: 1000, rating: 4.9, reviews: 89, tag: 'Trending', image: '/images/products/chocolate-cake.png' },
  { id: 3, name: 'Personalized Name Necklace', price: 1499, originalPrice: 1999, rating: 4.7, reviews: 210, tag: 'New', image: '/images/products/gold-necklace.png' },
  { id: 4, name: 'Zen Bliss Personal Retreat Kit', price: 2499, originalPrice: 2999, rating: 4.6, reviews: 56, tag: 'Premium', image: '/images/products/wellness-kit.png' },
];
